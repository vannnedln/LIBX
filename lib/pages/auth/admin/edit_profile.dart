...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  bool _isLoadingProfile = true; // Add this property
  ...
  // Move _updateProfile function outside of build method
  Future<void> _updateProfile() async {
    try {
      ...
      // If we have a new image, add it to the updates
      if (_imageFile != null) {
      ...
      // In the _updateProfile method, update the success QuickAlert
      if (mounted) {
        QuickAlert.show(
          context: context,
          ...
          onConfirmBtnTap: () {
            ...
            Navigator.pop(
                context, true); // Return to profile settings with refresh flag
          },
        );
      }
    } catch (e) {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 30),
                    // Save Button
                    // In the Save Button section, update to:
                    SizedBox(
